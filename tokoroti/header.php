...
<body>
	<div class="container-fluid" >
		<div class="row top" style="background-color: #0a6683;">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6281368626223</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> akbarbakery@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span> Akbar Bakery Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #0a6683"><b>AKBAR BAKERY</b></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="manual.php">Cara Pemesanan</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
